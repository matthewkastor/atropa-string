...
In the browser this module is attached to the global namespace `atropa`, which
 ...
 Include `./browser/atropa-string_web.js` in your page and
...
To run the browser tests open `browser/atropa-string_tests.html` in your
...
If you alter the source in `src/atropa-string.js` please run the
